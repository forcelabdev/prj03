        ...
        {!isLoading && currentTransactions.length > 0 && (
          <div style={{ backgroundColor: "#ffffff", borderRadius: "6px", overflow: "hidden" }}>
            {currentTransactions.map((item, index) => {
              const truncatedId = item._id.length > 24
                ? item._id.slice(0, 24) + "..."
                : item._id
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-gray-700 text-sm font-normal truncate">{truncatedId}</p>
                    <p className="text-gray-500 text-xs mt-0.5">{formatDate(item.createdAt)}</p>
                  </div>
                  ...
                  {/* Sağ: tutar + upload ikonu */}
                  <div className="text-right flex-shrink-0">
                    <p className="text-gray-900 text-sm font-medium">{formatCurrency(item.amount)}</p>
