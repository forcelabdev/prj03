...
export const userService = {
  // GET /users/:id - Kullanici profili (Zorunlu  - sadece kendi profili)
  ...
  // PUT /users/:id - Profil guncelle (Zorunlu  - sadece kendi profili)
  ...
  // POST /users/switch-wallet - Wallet degistir (Zorunlu )
  ...
  // POST /wallet/convert-to-fiat - Tum bakiyeleri fiat'a donustur (Zorunlu )
  ...
  // POST /exchange/switch-fiat-currency - Fiat para birimi degistir (Zorunlu )
  ...
  // GET //sports-bets - Spor bahisleri (Zorunlu )
  async getSportsBets(): Promise<{ success: boolean; bets?: any[]; pagination?: any; error?: string }> {
    const response = await apiClient.get<{ success: boolean; bets: any[]; pagination: any }>('//sports-bets', true);
  ...
  // GET //sports-bets/:betId - Tek bahis detayi (Zorunlu )
  async getSportsBetDetail(betId: string): Promise<{ success: boolean; bet?: any; error?: string }> {
    const response = await apiClient.get<{ success: boolean; bet: any }>(`//sports-bets/${betId}`, true);
  ...
  // GET //sports-bets-stats - Spor bahis istatistikleri (Zorunlu )
  async getSportsBetsStats(): Promise<{ success: boolean; stats?: any; error?: string }> {
    const response = await apiClient.get<{ success: boolean; stats: any }>('//sports-bets-stats', true);
